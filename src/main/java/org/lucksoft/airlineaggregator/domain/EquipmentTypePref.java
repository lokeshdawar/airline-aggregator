    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            Boolean theWideBody;
            theWideBody = this.isWideBody();
            strategy.appendField(locator, this, "wideBody", buffer, theWideBody);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EquipmentTypePref)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final EquipmentTypePref that = ((EquipmentTypePref) object);
        {
            Boolean lhsWideBody;
            lhsWideBody = this.isWideBody();
            Boolean rhsWideBody;
            rhsWideBody = that.isWideBody();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "wideBody", lhsWideBody), LocatorUtils.property(thatLocator, "wideBody", rhsWideBody), lhsWideBody, rhsWideBody)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            Boolean theWideBody;
            theWideBody = this.isWideBody();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "wideBody", theWideBody), currentHashCode, theWideBody);
        }
        {
            PreferLevelType thePreferLevel;
            thePreferLevel = this.getPreferLevel();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EquipmentTypePref) {
            final EquipmentTypePref copy = ((EquipmentTypePref) draftCopy);
            if (this.wideBody!= null) {
                Boolean sourceWideBody;
                sourceWideBody = this.isWideBody();
                Boolean copyWideBody = ((Boolean) strategy.copy(LocatorUtils.property(locator, "wideBody", sourceWideBody), sourceWideBody));
                copy.setWideBody(copyWideBody);
            } else {
                copy.wideBody = null;
            }
