    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CountryNameType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CountryNameType that = ((CountryNameType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CountryNameType) {
            final CountryNameType copy = ((CountryNameType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
