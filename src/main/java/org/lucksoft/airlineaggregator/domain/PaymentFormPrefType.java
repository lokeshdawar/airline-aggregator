    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PaymentFormPrefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PaymentFormPrefType that = ((PaymentFormPrefType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PaymentFormPrefType) {
            final PaymentFormPrefType copy = ((PaymentFormPrefType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
