    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TPAExtensionsType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TPAExtensionsType that = ((TPAExtensionsType) object);
        {
            List<Element> lhsAny;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TPAExtensionsType) {
            final TPAExtensionsType copy = ((TPAExtensionsType) draftCopy);
