    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LoyaltyPrefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LoyaltyPrefType that = ((LoyaltyPrefType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LoyaltyPrefType) {
            final LoyaltyPrefType copy = ((LoyaltyPrefType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
