    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InterestPrefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InterestPrefType that = ((InterestPrefType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InterestPrefType) {
            final InterestPrefType copy = ((InterestPrefType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
