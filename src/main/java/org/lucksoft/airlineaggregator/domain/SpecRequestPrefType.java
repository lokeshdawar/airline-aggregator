    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SpecRequestPrefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SpecRequestPrefType that = ((SpecRequestPrefType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SpecRequestPrefType) {
            final SpecRequestPrefType copy = ((SpecRequestPrefType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
