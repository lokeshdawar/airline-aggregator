    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theNodeList;
            theNodeList = this.getNodeList();
            strategy.appendField(locator, this, "nodeList", buffer, theNodeList);
        }
        {
            String theShortText;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsNodeList;
            lhsNodeList = this.getNodeList();
            String rhsNodeList;
            rhsNodeList = that.getNodeList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nodeList", lhsNodeList), LocatorUtils.property(thatLocator, "nodeList", rhsNodeList), lhsNodeList, rhsNodeList)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theNodeList;
            theNodeList = this.getNodeList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nodeList", theNodeList), currentHashCode, theNodeList);
        }
        {
            String theShortText;
            theShortText = this.getShortText();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ErrorType) {
            final ErrorType copy = ((ErrorType) draftCopy);
            if (this.type!= null) {
                String sourceType;
            ...
            if (this.nodeList!= null) {
                String sourceNodeList;
                sourceNodeList = this.getNodeList();
                String copyNodeList = ((String) strategy.copy(LocatorUtils.property(locator, "nodeList", sourceNodeList), sourceNodeList));
                copy.setNodeList(copyNodeList);
            } else {
                copy.nodeList = null;
            }
