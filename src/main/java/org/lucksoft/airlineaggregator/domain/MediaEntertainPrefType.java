    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MediaEntertainPrefType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MediaEntertainPrefType that = ((MediaEntertainPrefType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MediaEntertainPrefType) {
            final MediaEntertainPrefType copy = ((MediaEntertainPrefType) draftCopy);
            if (this.value!= null) {
                String sourceValue;
